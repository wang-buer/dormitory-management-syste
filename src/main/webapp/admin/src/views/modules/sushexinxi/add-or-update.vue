          ...
          <el-form-item class="input" label="可住人数" prop="kezhurenshu">
              <el-input v-model="ruleForm.kezhurenshu" 
                placeholder="可住人数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="已住人数" prop="yizhurenshu">
          <el-input v-model="ruleForm.yizhurenshu" 
              placeholder="已住人数" clearable  :readonly="ro.yizhurenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="已住人数" prop="yizhurenshu">
              <el-input v-model="ruleForm.yizhurenshu" 
