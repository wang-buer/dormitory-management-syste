<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="访客姓名" prop="fangkexingming">
          <el-input v-model="ruleForm.fangkexingming" 
              placeholder="访客姓名" clearable  :readonly="ro.fangkexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="访客姓名" prop="fangkexingming">
              <el-input v-model="ruleForm.fangkexingming" 
                placeholder="访客姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="电话" prop="dianhua">
              <el-input v-model="ruleForm.dianhua" 
                placeholder="电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="宿舍号" prop="sushehao">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.sushehao"
                placeholder="宿舍号" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="来访时间" prop="laifangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.laifangshijian" label="来访时间" prop="laifangshijian">
              <el-input v-model="ruleForm.laifangshijian" 
                placeholder="来访时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="离开时间" prop="likaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.likaishijian" label="离开时间" prop="likaishijian">
              <el-input v-model="ruleForm.likaishijian" 
                placeholder="离开时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
                placeholder="备注" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="到访原因" prop="daofangyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="到访原因"
                  v-model="ruleForm.daofangyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.daofangyuanyin" label="到访原因" prop="daofangyuanyin">
                    <span>{{ruleForm.daofangyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sushehao = true;
            continue;
	            	            ...
	            	            if(o=='daofangyuanyin'){
            this.ruleForm.daofangyuanyin = obj[o];
	    this.ro.daofangyuanyin = true;
            continue;
          }
	            	            if(o=='laifangshijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fangkexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fangkexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
