          ...
          <el-form-item class="input" label="宿舍号" prop="sushehao">
              <el-input v-model="ruleForm.sushehao" 
                placeholder="宿舍号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报修物品" prop="baoxiuwupin">
          <el-input v-model="ruleForm.baoxiuwupin" 
              placeholder="报修物品" clearable  :readonly="ro.baoxiuwupin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报修物品" prop="baoxiuwupin">
              <el-input v-model="ruleForm.baoxiuwupin" 
                placeholder="报修物品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="24">  
